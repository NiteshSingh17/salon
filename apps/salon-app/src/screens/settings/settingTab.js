        ...
        <View style={style.headerContainer}>
          ...
          <View style={{ flexGrow: 1, paddingRight: 20 }}>
            <View style={style.nameConatiner}>
              <TextX numberOfLines={1} variant="headlineMedium">
                {shopData.name}
              </TextX>
            </View>
            <TextX secondary>{shopData.email}</TextX>
          </View>
          <View>
              ...
              <Fragment key={option.title}>
                <TouchableRipple onPress={() => handleClick(option.path)}>
                  <View style={style.settingItem}>
                    ...
                    <View>
                      <TextX variant="headlineSmall">{option.title}</TextX>
                      <TextX secondary>{option.desc}</TextX>
                    </View>
                  </View>
                </TouchableRipple>
                <Divider />
