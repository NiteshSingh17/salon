        ...
        <Container style={style.detailsContainer}>
          ...
          <View>
            <View style={style.detailContainer}>
              <View>
                <TextX style={style.title} secondary variant="textSmall">
                  Shop name
                </TextX>
                <TextX variant="headlineSmall">{shopData.name}</TextX>
              </View>
              <IconButton
                onPress={() =>
                  setEditDetail({
          ...
          <View>
            ...
            <TextX variant="headlineSmall">{shopData.tagline ?? "-"}</TextX>
            <Divider style={style.divider} />
          </View>
          <View>
            <TextX style={style.title} secondary variant="textSmall">
            ...
            <TextX variant="headlineSmall">{shopData.contact ?? "-"}</TextX>
            <Divider style={style.divider} />
          </View>
          <View>
            <TextX style={style.title} secondary variant="textSmall">
            ...
            <TextX variant="headlineSmall">{shopData.email ?? "-"}</TextX>
            <Divider style={style.divider} />
          </View>
